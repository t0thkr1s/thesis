...
\lstinputlisting[language=Java, label={room}, caption=A NotificationDao interfész.]{./codes/NotificationDao.java}
...
\lstinputlisting[language=Java, label={saving_sharedpref}, caption=Adatok mentése \emph{SharedPreferences} segítségével.]{./codes/saving_sharedpref.java}
...
\lstinputlisting[language=Java, label={deleting_sharedpref}, caption=Az összes mentett adat törlése.]{./codes/deleting_sharedprefs.java}
...
Az APK fájlok feltöltését háttér service komponensel készítettem el.
