...
Több nagy cég is a CircleCi szolgáltatását használja a folyamatos integráláshoz.
Ilyen például a \emph{Facebook}, \emph{Spotify}, \emph{Kickstarter} és a \emph{GoPro}.

A CircleCi integrálható a Github-al, így kényelmesen tudjuk csatolni a projekteket.
% Ezen kívül még létre kell hozni egyszerű
