...
Ez a DAO nyújtja a hozzáférést az adatbázis réteghez.
Jól látható, hogy itt is annotációkkal kell megjelölni a metódusokat.
% Ahol, paraméterben SQL\footnote{Structured Query Language} utasítást látunk, az mind futási időben ellenőrizve van, így nem kell aggódni 
